...
import type * as RMCs from '@/types/nex/rmcs/ticket-granting/validate-and-request-ticket-with-custom-data';

export class Request {
	public static Name = 'ValidateAndRequestTicketWithCustomData';
