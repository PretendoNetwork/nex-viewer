...
export class Request {
	public static Name = 'GetRankingByUniqueIdList';

	private nexUniqueIdList = new List(new UInt64());
	...
	constructor(message: RMCMessage) {
		...
		this.nexUniqueIdList.extractFrom(stream);
	...
	public toJSON(): any {
		return {
			nexUniqueIdList: this.nexUniqueIdList,
